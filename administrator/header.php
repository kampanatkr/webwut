      ...
      <div class="container"><div class="container-fluid">
        <div class="row">
          ...
          if ($LOGGEDIN) {
            ...
            <?php 
            if ($_SESSION['ROLE'] != "AD")
            echo '<a href="../profile.php-scripts"><i class="material-icons" style="font-size:48px;color:#61b3cf">account_box</i></a>
            <a href="personalMessage.php-scripts"><i class="material-icons" style="font-size:48px;color:#df8a83">mail</i></a>';
            ?>
